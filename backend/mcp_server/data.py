...
TICKETS = [
    {
        "ticket_id": "OPS-18231",
        "incident_ref": "INC-PAY-2025-041",
        "service": "card-authorization",
        "status": "closed",
        "priority": "P1",
        "opened": "2025-10-03",
        "closed": "2025-10-03",
        "summary": "Card declines - processor mTLS certificate expired",
        "assignee_team": "payments-engineering",
    },
    {
        "ticket_id": "OPS-18644",
        "incident_ref": "INC-PAY-2025-044",
        "service": "payments-ledger",
        "status": "closed",
        "priority": "P1",
        "opened": "2025-10-31",
        "closed": "2025-11-01",
        "summary": "Ledger connection pool exhausted on salary day",
        "assignee_team": "payments-engineering",
    },
    {
        "ticket_id": "OPS-19410",
        "incident_ref": "INC-PAY-2025-052",
        "service": "card-authorization",
        "status": "closed",
        "priority": "P2",
        "opened": "2025-12-12",
        "closed": "2025-12-13",
        "summary": "CardNet processor timeouts",
        "assignee_team": "vendor-management",
    },
    {
        "ticket_id": "OPS-19877",
        "incident_ref": "INC-PAY-2026-003",
        "service": "instant-payments",
        "status": "closed",
        "priority": "P2",
        "opened": "2026-01-09",
        "closed": "2026-01-10",
        "summary": "Instant payments rejected after release 4.18",
        "assignee_team": "payments-engineering",
    },
    {
        "ticket_id": "OPS-20512",
        "incident_ref": "INC-PAY-2026-011",
        "service": "mobile-wallet",
        "status": "closed",
        "priority": "P2",
        "opened": "2026-02-27",
        "closed": "2026-02-27",
        "summary": "Wallet top-ups failing - internal gateway cert expired",
        "assignee_team": "platform-security",
    },
    {
        "ticket_id": "OPS-21140",
        "incident_ref": "INC-PAY-2026-019",
        "service": "bill-payments",
        "status": "closed",
        "priority": "P2",
        "opened": "2026-03-31",
        "closed": "2026-04-01",
        "summary": "Month-end bill payment failures - pool saturation",
        "assignee_team": "data-platform",
    },
    {
        "ticket_id": "OPS-22035",
        "incident_ref": "INC-PAY-2026-027",
        "service": "cross-border-payments",
        "status": "closed",
        "priority": "P2",
        "opened": "2026-05-15",
        "closed": "2026-05-16",
        "summary": "FX routing flag enabled at 100%",
        "assignee_team": "devops",
    },
    {
        "ticket_id": "OPS-22790",
        "incident_ref": "INC-PAY-2026-033",
        "service": "standing-orders",
        "status": "closed",
        "priority": "P2",
        "opened": "2026-06-30",
        "closed": "2026-07-01",
        "summary": "Standing order batch failed - ledger pool exhaustion",
        "assignee_team": "payments-engineering",
    },
    {
        "ticket_id": "OPS-23311",
        "incident_ref": "INC-PAY-2026-038",
        "service": "merchant-qr",
        "status": "closed",
        "priority": "P3",
        "opened": "2026-07-24",
        "closed": "2026-07-24",
        "summary": "LankaAcquire outage - QR payments failing",
        "assignee_team": "payments-product",
    },
    {
        "ticket_id": "OPS-23958",
        "incident_ref": "INC-PAY-2026-045",
        "service": "swift-gateway",
        "status": "closed",
        "priority": "P1",
        "opened": "2026-08-21",
        "closed": "2026-08-22",
        "summary": "SWIFT signing blocked - HSM certificate expired",
        "assignee_team": "platform-security",
    },
    {
        "ticket_id": "OPS-24402",
        ...
        "opened": "2026-09-08",
        "closed": None,
        "summary": "Pool utilisation at 78% during salary-day rehearsal",
        "assignee_team": "payments-engineering",
    },
    {
        "ticket_id": "OPS-24417",
        ...
        "opened": "2026-09-11",
        "closed": None,
        "summary": "CardNet client certificate expires in 21 days - renewal automation failed",
        "assignee_team": "platform-security",
    },
]
...
SERVICE_STATUS = {
    "card-authorization": {
        ...
        "note": "Elevated processor latency since 09:40",
    },
...
ONCALL = {
    "payments-engineering": {
        "primary": "Nimal Perera",
        "secondary": "Ayesha Fernando",
        "escalation": "Head of Payments Engineering",
    },
    "platform-security": {
        "primary": "Kavindu Silva",
        "secondary": "Dilini Jayawardena",
        "escalation": "Platform Security Manager",
    },
